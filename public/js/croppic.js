...
(function (window, document) {
    ...
    Croppic.prototype = {
        ...
        init: function () {
            ...
            that.objW = that.options.modalWidth;
            that.objH = that.options.modalHeight;
        ...
        afterCrop: function (data) {
            ...
            if (response.status == 'success') {
                ...
                that.croppedImg = $('.croppedImg');
                that.croppedImg.attr("src", response.url);
