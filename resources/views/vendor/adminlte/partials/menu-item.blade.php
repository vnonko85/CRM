...
@elseif ($item['account_settings'] ?? false)
    <li class="profile">
        <div class="user-panel text-centre">
            <div class="pull image">
                 <img src="{{ asset(Auth::user()->getPhoto()) }}" class="img-circle" alt="User Image">
            </div>
        </div>
        <div>
            <a href="/">
        ...
        <div class="control-profile">
            <a href="#" class="user-icon">
                <i class="far fa-eye" title="Мой профиль"></i>
            </a>
            <a href="/profile" class="user-icon">
                <i class="fas fa-pencil-alt" title="Редактировать профиль"></i>
            </a>
        </div>
    </li>
