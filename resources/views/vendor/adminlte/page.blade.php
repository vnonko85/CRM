        ...
        <header class="main-header">
            ...
            <nav class="navbar navbar-fixed-top navbar-expand-lg navbar-dark bg-dark">
                ...
                <div class="active-cyan-4 mb-4">
                    <form action="#" method="GET" class="form-inline flex-nowrap bg-light mx-0 mx-lg-auto rounded p-1">
                        <div class="input-group">
                          <input type="search" name="q" class="form-control mr-sm-2" placeholder="search" aria-label='Search'>
                          <span class="input-group-btn">
                                <button type="submit" name="search" id="search-btn" class="btn btn-outline-succcess">
